...
public struct AuxiliaryMeaning: Codable, Equatable, Hashable, Sendable {
    public let meaning: String
...
public struct ContextSentence: Codable, Equatable, Hashable, Sendable {
...
public struct PronunciationAudio: Codable, Equatable, Hashable, Sendable {
...
public struct AudioMetadata: Codable, Equatable, Hashable, Sendable {
